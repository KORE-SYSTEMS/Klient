...
import { Play, Square, Clock, X, Minimize2 } from "lucide-react";
...
export function useActiveTimer() {
  ...
  return { activeTimer, elapsed, startTimer, stopTimer, fetchActive };
}

// Floating Timer Widget — shows bottom-right when a timer is running
export function FloatingTimer({
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 animate-in slide-in-from-bottom-4 fade-in duration-300">
      <Card className="w-[300px] overflow-hidden border shadow-2xl">
