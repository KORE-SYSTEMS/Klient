...
const toastVariants = cva(
  [
    ...
    "overflow-hidden rounded-sm border bg-card p-4 pr-8",
  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        success:   "border-l-[3px] border-l-success border-border text-foreground",
        warning:   "border-l-[3px] border-l-warning border-border text-foreground",
        info:      "border-l-[3px] border-l-info border-border text-foreground",
        destructive: "border-l-[3px] border-l-destructive border-border text-foreground",
      },
    },
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-7 shrink-0 items-center justify-center rounded-sm border bg-transparent px-2.5 text-xs font-medium",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-sm p-0.5 text-foreground/40",
